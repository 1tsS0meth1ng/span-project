...
class TestSoccerTeam(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(soccer_team.competitor_name, team_name)
    ...
    def test_team_name_property(self):
        ...
        soccer_team.competitor_name = new_team_name
        self.assertEqual(soccer_team.competitor_name, new_team_name)

        # test setter when incorrect input (incorrect type)
        new_incorrect_team_name: int = 1234565

        with self.assertRaises(TypeError):
            soccer_team.competitor_name = new_incorrect_team_name
